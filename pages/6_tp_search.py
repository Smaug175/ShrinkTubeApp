...
machine_big_graph_number = {
    "DC0128": ['AD01', 'AD01_', 'ADIE', 'ADIE_', 'ADBT', 'ADBT_', 'AD04']
}
...
if st.button("查询", on_click=query_all_data, use_container_width=True, type="primary", kwargs={'machine': machine_type, 'big_graph_number': mold_list}):
    st.divider()
